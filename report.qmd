...
predict(model_coal, data.frame(Year = 2050, Country.Name = "Untied States"))
```
...
```{r}
#| label: model_gas_predict

predict(model_gas, data.frame(Year = 2050, Country.Name = "Untied States"))
