...
target_emissions |> 
  ...
  labs( 
    ...
    y = "% of Total CO2 Emissions from Coal (Metric Tons Per Capita)", 
    color = "Country") +
  theme(plot.title = element_text(size = 11), 
        axis.title = element_text(size = 10), 
        axis.text.x = element_text(angle = 90, vjust = 0.75, hjust = 0.5))
```
...
target_emissions <- target_emissions |> 
  mutate(percent_total_gas= (Emissions.Production.CO2.Gas/Emissions.Production.CO2.Total) *100)
```
...
target_emissions |> 
  ...
  facet_wrap(~ Country.Name, scales = "free_y") + 
  labs( 
    title = "Percentage of Total CO2 Emissions from Gas vs GDP By Country (1992-2018)", 
    x = "Country's Gross Domestic Product for a Given Year", 
    y = "% of Total CO2 Emissions from Gas (Metric Tons Per Capita)", 
    color = "Country") +
  theme(plot.title = element_text(size = 11), 
        axis.title = element_text(size = 10), 
        axis.text.x = element_text(angle = 90, vjust = 0.75, hjust = 0.5))
...
target_emissions <- target_emissions |> 
  mutate(percent_total_oil= (Emissions.Production.CO2.Oil/Emissions.Production.CO2.Total) *100)
```
...
target_emissions |> 
  ...
  facet_wrap(~ Country.Name, scales = "free_y") + 
  labs( 
    title = "Percentage of Total CO2 Emissions from Oil vs GDP By Country (1992-2018)", 
    x = "Country's Gross Domestic Product for a Given Year", 
    y = "% of Total CO2 Emissions from Oil (Metric Tons Per Capita)", 
    color = "Country") +
  theme(plot.title = element_text(size = 11), 
        axis.title = element_text(size = 10), 
        axis.text.x = element_text(angle = 90, vjust = 0.75, hjust = 0.5))
