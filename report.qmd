...
**Conclusion:**
- in conclusions with greater gdp countries have resources to invest in reneable energy 
- can predict the future- a future transitions to renewable sources in the US 
- to stop the trends that we see right now- we NEEED a transition to green engery 
- but we also need to foucs on helping developing so that they can continue to grow WITHOUT fossil fuels annd differ from the trends we have shown above 
- propse future research/more work to build on this 