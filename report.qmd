...
In general, India and China are growing the fastest in consumption for all three modes of energy. By 2050, these two countries would be consuming over 19000 metric tons per capita in coal with China contributing over 85%. For gas, the United States will remain a majority consumer but the two countries will be grown more dramtically by consuming over 1100 metric tons per capita. For oil, India and China will consume over 3900 metric tons per capita. Our hypothesis was rejected because China consumes more than India in all three forms and over consumes the United States in all by gas. We suggest that since the United States is a greater stage of development, they should start using more alternative energy forms and renewable forms of energy. The slight steadiness in the trend lines of the United States support this idea along with the subtle declines present in coal and oil.
