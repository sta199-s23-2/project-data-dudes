...
linear_reg() |>
  set_engine("lm") |>
  fit(Emissions.Production.CO2.Coal ~ Year, data = target_emissions) |>
  glance() |>
  pull(r.squared)
...
linear_reg() |>
  set_engine("lm") |>
  fit(Emissions.Production.CO2.Gas ~ Year, data = target_emissions) |>
  glance() |>
  pull(r.squared)
...
linear_reg() |>
  set_engine("lm") |>
  fit(Emissions.Production.CO2.Oil ~ Year, data = target_emissions) |>
  glance() |>
  pull(r.squared)
